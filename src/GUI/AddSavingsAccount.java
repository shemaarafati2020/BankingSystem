...
public class AddSavingsAccount extends JFrame {
        ...
        public AddSavingsAccount() {
                ...
                limitField.setBounds(144, 160, 254, 20);
                ...
                btnAdd.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                try {
                                        ...
                                        double maxw = Double.parseDouble(limitField.getText().trim());

                                        if (name.isEmpty() || bal <= 0 || maxw <= 0) {
                                        ...
                                        if (bal < 2000) {
                                                JOptionPane.showMessageDialog(getComponent(0),
                                                                "Minimum initial balance for savings is 2000", "Warning",
                                                                0);
                                                return;
                                        }

                                        int ch = JOptionPane.showConfirmDialog(getComponent(0),
                                                        "Create savings account for " + name + "?");
                                        if (ch == 0) {
                                        ...
                                        JOptionPane.showMessageDialog(getComponent(0),
                                                        "Please provide numeric values for balance and withdraw limit",
                                                        "Warning", 0);
                                } catch (Exception ex) {
                                        JOptionPane.showMessageDialog(getComponent(0),
